"""
Django settings for crousplay project.
...
SECRET_KEY = os.environ["CROUSPLAY_SECRET_KEY"]
...
STATIC_ROOT = None if not os.getenv("CROUSPLAY_STATIC_DIR") else Path(os.environ["CROUSPLAY_STATIC_DIR"])
...
WSGI_APPLICATION = "crousplay.wsgi.application"
