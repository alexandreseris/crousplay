        ...
        with transaction.atomic():
            ...
            monopoly = save(
                models.Game.init(
                    ...
                    rules_link="https://www.monopolypedia.fr/regles/regle_euros.php",
            ...
            codenames = save(
                models.Game.init(
                    ...
                    rules_link="https://www.provincedeliege.be/sites/default/files/media/15553/Dixit%20-%20R%C3%A8gle.pdf",
            ...
            dixit = save(
                models.Game.init(
                    ...
                    rules_link="https://www.provincedeliege.be/sites/default/files/media/15553/Code%20Names%20-%20R%C3%A8gles.pdf",
                    min_number_of_player=4,
            ...
            terraforming_mars = save(
                models.Game.init(
                    ...
                    rules_link="https://cdn.1j1ju.com/medias/0a/b5/53-terraforming-mars-regle.pdf",
                    min_number_of_player=4,
                    max_number_of_player=10,
                    min_duration=30,
                    max_duration=100,
